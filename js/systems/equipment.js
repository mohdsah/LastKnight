...
// ── Sync RARITY_COLOR dengan window.RARITY ────────────
// Pastikan RARITY_COLOR (digunakan farming.js & ui.js) sentiasa konsisten
window.RARITY_COLOR = {};
for (const [k, v] of Object.entries(window.RARITY)) {
  window.RARITY_COLOR[k] = v.color;
}
