...
window.DailyQuest = {
  ...
  notifyComplete(quest) {
    ...
    if (fl) { fl.textContent=`✅ Quest: ${quest.label}`; fl.style.display='block'; setTimeout(()=>{ if(fl) fl.style.display='none'; },3000); }
  },
