...
const window.ENH_RATES=[{success:100,fail:0,break:0},{success:95,fail:5,break:0},{success:85,fail:15,break:0},{success:70,fail:25,break:5},{success:55,fail:32,break:13},{success:40,fail:38,break:22},{success:28,fail:38,break:34},{success:18,fail:40,break:42},{success:10,fail:42,break:48}];

const window.REV_RATES=[{success:60,fail:35,break:5},{success:40,fail:45,break:15},{success:25,fail:45,break:30}];

const window.SHOPS={general:{name:'Kedai Am',tabs:{Potion:['hpot_sm','hpot_md','hpot_lg','hpot_xl','mpot_sm','mpot_md','mpot_lg'],Scroll:['town_scroll','tp_scroll','revive_stone'],Bahan:['luna_stone','wraith_stone','monsters_bead','iron_ore','magic_dust'],Elixir:['elixir_power','elixir_speed','elixir_guard','antidote']}},weapons:{name:'Senjata & Armor',tabs:{Senjata:['sword_iron','sword_steel','dagger_basic','dagger_dark','staff_oak','staff_magic'],Armor:['armor_leather','armor_chain','robe_silk','helm_iron','glove_leather','boot_cloth'],Aksesori:['ring_iron','ring_gold','ring_fire','amulet_jade','amulet_power']}},enhance:{name:'Naik Taraf',tabs:{Bahan:['luna_stone','wraith_stone','chaos_stone','star_stone']}},elmorad:{name:'Kedai El Morad',tabs:{Khas:['earring_el','sword_knight','armor_plate','hpot_lg','mpot_md']}},karus:{name:'Kedai Karus',tabs:{Khas:['earring_kr','dagger_shadow','staff_divine','hpot_lg','mpot_md']}}};
...
window.REV_RATES    = window.REV_RATES;
