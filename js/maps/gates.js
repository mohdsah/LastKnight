...
window.addEventListener('load', function() {
  ...
  window.GATES['ardream'] = [
    { id:'gate_back_ronark', name:'🏙️ Kembali Ronark',    to:'ronark',   x:1200, y:680,  icon:'🚪', color:'#888888' },
  ...
  window.GATES['luferson'] = [
    { id:'gate_back_ardream', name:'↩ Kembali Ardream',   to:'ardream',  x:1200, y:600,  icon:'🚪', color:'#888888' },
    { id:'gate_back_ronark2', name:'🏙️ Kembali Ronark',   to:'ronark',   x:900,  y:900,  icon:'🚪', color:'#888888' },
  ];

  // Ardean Basin gates
  window.GATES['ardean'] = [
    { id:'gate_back_luf',     name:'↩ Kembali Luferson',  to:'luferson', x:1200, y:600,  icon:'🚪', color:'#888888' },
  ];
});
