...
function equipCostume(costumeId) {
  ...
  if (G.pl) G.pl.activeCostume = costumeId ? PSTORE_ITEMS.costume.find(c=>c.costumeId===costumeId) : null;
  saveProgress();
  renderCostumePanel();
...
// ── LOAD: restore point dan costume ──────────────────────────────
const _origRestoreMaster = restoreMasterData;
restoreMasterData = function(ch) {
